      ...
      isInCart ? (
        <div className="count_cart bg-red">
          <button onClick={handleDecrement} className="decrement bg-red">
            <img src="/src/assets/images/icon-decrement-quantity.svg" alt="decrement-icon" />
          </button>
          <p>{count}</p>
          <button onClick={handleIncrement} className="increment bg-red">
            <img src="/src/assets/images/icon-increment-quantity.svg" alt="increment-icon" />
          </button>
        </div>
      ) : (
        <button onClick={handleAddToCart} className="add_cart">
          <img src="/src/assets/images/icon-add-to-cart.svg" alt="add-icon" />
          <p>Add to cart</p>
        </button>
      )
  )
