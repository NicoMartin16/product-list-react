  ...
  return (
    <div className="overlay">
      <div className="modal-confirm">
          ...
          {productsSelected.map((product, index) => (
            <div key={index} className="product">
                ...
                <div className="container-image">
                  <img
                    src={`${import.meta.env.BASE_URL}${
                      product.image.desktop.startsWith("/")
                        ? product.image.desktop.substring(1)
              ...
              <div className="product-total">
                <p className="product-total-price rose-900">
        ...
        <button className="button-new-order bg-red" onClick={handleOnClose}>
          Start New Order
        </button>
      </div>
    </div>
